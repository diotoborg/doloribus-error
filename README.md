...
[![NPM](https://nodei.co/npm/@diotoborg/doloribus-error.png)](https://nodei.co/npm/@diotoborg/doloribus-error/)

[![Build Status](https://travis-ci.org/diotoborg/doloribus-error.svg)](https://travis-ci.org/diotoborg/doloribus-error)
[![Coverage Status](https://coveralls.io/repos/diotoborg/doloribus-error/badge.png)](https://coveralls.io/r/diotoborg/doloribus-error)
...
```js
var bbu = require('@diotoborg/doloribus-error');
